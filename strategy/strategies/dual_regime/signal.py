...
Delegates to DualRegimeSignalCore for bar-by-bar signal generation,
...
# Fields that belong to DualRegimeConfig (for splitting params)
_CONFIG_FIELDS = {f.name for f in dataclasses.fields(DualRegimeConfig)}


class DualRegimeSignalGenerator:
    """Generate trading signals for dual regime backtest.

    Delegates to DualRegimeSignalCore for bar-by-bar processing.
    """
