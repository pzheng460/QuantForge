...
_core = _import_local_module("_hk_core", _SCRIPT_DIR / "core.py", "strategy.strategies.hurst_kalman.core")
_configs = _import_local_module("_hk_configs", _SCRIPT_DIR / "configs.py", "strategy.strategies.hurst_kalman.configs")
