...
Usage:
    uv run python -m strategy.strategies.ema_crossover.live

Log output:
    strategy/strategies/ema_crossover/strategy_output.log
"""
...
from strategy.strategies.ema_crossover.configs import (  # noqa: E402
    EMATradeFilterConfig,
    get_config,
)
from strategy.strategies.ema_crossover.core import EMAConfig  # noqa: E402
from strategy.strategies.ema_crossover.indicator import EMACrossoverIndicator  # noqa: E402
...
class EMACrossoverStrategy(BaseQuantStrategy):
    ...
    def _on_live_activated(
        ...
        """Enable live mode on the indicator (switches from warmup to core.update())."""
    ...
    def _process_signal(
        ...
        """Use managed signal mode — core already handles position management."""
...
#
# Generate configs: uv run python strategy/strategies/ema_crossover/backtest.py --heatmap
# List configs:     python -m strategy.strategies.ema_crossover.configs
# Override:         python -m strategy.strategies.ema_crossover.live --mesa 1
# =============================================================================
...
from nexustrader.constants import ExchangeType, settings  # noqa: E402
