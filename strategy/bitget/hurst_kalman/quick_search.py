...
_core = _imp("_hk_core", _SCRIPT_DIR/"core.py", "strategy.bitget.hurst_kalman.core")
_configs = _imp("_hk_configs", _SCRIPT_DIR/"configs.py", "strategy.bitget.hurst_kalman.configs")
