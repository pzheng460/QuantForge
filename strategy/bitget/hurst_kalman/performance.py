...
class PerformanceTracker:
    ...
    def __init__(
        ...
        if initial_balance > 0:
            if self._stats.initial_balance == 0 or abs(self._stats.initial_balance - initial_balance) > initial_balance * 0.5:
                ...
                self._stats.config_level = config_level
    ...
    def get_stats_summary(self) -> str:
        ...
        lines = [
            ...
            f"Config: Level {s.config_level} ({s.config_name})",
            "-" * 60,
    ...
    def reset(self, initial_balance: float = 0.0) -> None:
        ...
        self._stats = PerformanceStats(
            ...
            current_balance=initial_balance,
            peak_balance=initial_balance,
            config_level=self._stats.config_level,
