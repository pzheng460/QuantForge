...
Usage:
    # Show help
    uv run python -m strategy.bitget.grid --help
    
    # Run strategy (default settings)
    uv run python -m strategy.bitget.grid
    
    # Run in background with tmux
    tmux new-session -d -s grid "cd /home/pzheng46/NexusTrader && uv run python -m strategy.bitget.grid"
"""
...
from strategy.bitget.grid.strategy import create_strategy
...
Examples:
  ...
  # Run in background with tmux
  tmux new-session -d -s grid "cd /home/pzheng46/NexusTrader && uv run python -m strategy.bitget.grid 2>&1 | tee /tmp/grid_start.log"
