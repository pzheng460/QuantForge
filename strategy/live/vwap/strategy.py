...
Usage:
    uv run python -m strategy.live.vwap.strategy

Log output:
    strategy/live/vwap/strategy_output.log
"""
...
from strategy.live.vwap.configs import (  # noqa: E402
    VWAPTradeFilterConfig,
    get_config,
)
from strategy.strategies.vwap.core import VWAPConfig  # noqa: E402
from strategy.live.vwap.indicator import (  # noqa: E402
    VWAPIndicator,
    Signal,
)
...
# List configs:     python -m strategy.live.vwap.configs
# Override:         python -m strategy.live.vwap.strategy --mesa 1
# =============================================================================
