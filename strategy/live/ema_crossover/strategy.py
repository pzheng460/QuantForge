...
Usage:
    uv run python -m strategy.live.ema_crossover.strategy

Log output:
    strategy/live/ema_crossover/strategy_output.log
"""
...
from strategy.live.common.base_strategy import LogTee
...
from strategy.live.common.base_strategy import BaseQuantStrategy, PositionState
from strategy.live.ema_crossover.configs import (
    EMATradeFilterConfig,
    get_config,
)
from strategy.strategies.ema_crossover.core import EMAConfig
from strategy.live.ema_crossover.indicator import EMACrossoverIndicator
...
#
# Generate configs: uv run python strategy/live/ema_crossover/backtest.py --heatmap
# List configs:     python -m strategy.live.ema_crossover.configs
# Override:         python -m strategy.live.ema_crossover.strategy --mesa 1
# =============================================================================
