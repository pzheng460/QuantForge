...
Usage:
    uv run python -m strategy.live.funding_rate.strategy

Log output:
    strategy/live/funding_rate/strategy_output.log
"""
...
from strategy.live.funding_rate.configs import (  # noqa: E402
    FundingRateFilterConfig,
    get_config,
)
from strategy.strategies.funding_rate.core import FundingRateConfig  # noqa: E402
from strategy.live.funding_rate.indicator import (  # noqa: E402
