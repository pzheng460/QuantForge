...
Log output:
    strategy/live/hurst_kalman/strategy_output.log
"""
...
from strategy.live.hurst_kalman.configs import (
    TradeFilterConfig,
    get_config,
)
from strategy.strategies.hurst_kalman.core import HurstKalmanConfig
from strategy.live.hurst_kalman.indicator import (
    HurstKalmanIndicator,
    MarketState,
    Signal,
)
from strategy.live.hurst_kalman.performance import PerformanceTracker
...
#
# Generate configs: uv run python strategy/live/hurst_kalman/backtest.py --heatmap
# List configs:     python -m strategy.live.hurst_kalman.configs
# Override:         python -m strategy.live.hurst_kalman.strategy --mesa 1
# =============================================================================
