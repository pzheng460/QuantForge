...
_core = _imp("_hk_core", _SCRIPT_DIR/"core.py", "strategy.live.hurst_kalman.core")
_configs = _imp("_hk_configs", _SCRIPT_DIR/"configs.py", "strategy.live.hurst_kalman.configs")
