...
Usage:
    uv run python -m strategy.live.regime_ema.strategy

Log output:
    strategy/live/regime_ema/strategy_output.log
"""
...
from strategy.live.regime_ema.configs import (  # noqa: E402
...
from strategy.live.regime_ema.indicator import (  # noqa: E402
    RegimeEMAIndicator,
    Signal,
)
