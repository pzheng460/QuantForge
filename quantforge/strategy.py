...
from quantforge.base import ExchangeManager
from quantforge.indicator import IndicatorManager, Indicator, IndicatorProxy
from quantforge.core.entity import TaskManager, is_redis_available
from quantforge.core.cache import AsyncCache
from quantforge.error import StrategyBuildError
...
from quantforge.core.entity import OidGen
from quantforge.core.nautilius_core import MessageBus, LiveClock, Logger
...
class Strategy:
    ...
    def _init_core(
        ...
        if strategy_id and user_id and is_redis_available() and enable_cli:
            try:
                from quantforge.cli.monitor.state_exporter import StrategyStateExporter
