...
@auto_tune_group.command("run", context_settings=dict(ignore_unknown_options=True, allow_extra_args=True))
...
@optimizer_ab_group.command("orchestrate", context_settings=dict(ignore_unknown_options=True, allow_extra_args=True))
@click.argument("extra", nargs=-1, type=click.UNPROCESSED)
...
@optimizer_ab_group.command("runner", context_settings=dict(ignore_unknown_options=True, allow_extra_args=True))
@click.argument("extra", nargs=-1, type=click.UNPROCESSED)
...
@optimizer_ab_group.command("analyze", context_settings=dict(ignore_unknown_options=True, allow_extra_args=True))
@click.argument("extra", nargs=-1, type=click.UNPROCESSED)
...
@optimizer_ab_group.command("cross-review", context_settings=dict(ignore_unknown_options=True, allow_extra_args=True))
@click.argument("extra", nargs=-1, type=click.UNPROCESSED)
...
@optimizer_ab_group.command("holdout", context_settings=dict(ignore_unknown_options=True, allow_extra_args=True))
@click.argument("extra", nargs=-1, type=click.UNPROCESSED)
...
@optimizer_ab_group.command("plot", context_settings=dict(ignore_unknown_options=True, allow_extra_args=True))
@click.argument("extra", nargs=-1, type=click.UNPROCESSED)
def plot_cmd(extra):
...
@optimizer_ab_group.command("rebuild-csv", context_settings=dict(ignore_unknown_options=True, allow_extra_args=True))
@click.argument("extra", nargs=-1, type=click.UNPROCESSED)
