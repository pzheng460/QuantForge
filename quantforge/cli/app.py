...
from quantforge.cli.widgets.dashboard import DashboardWidget
from quantforge.cli.widgets.positions import PositionsWidget
from quantforge.cli.widgets.balances import BalancesWidget
from quantforge.core.entity import get_redis_client_if_available


class QuantForgeMonitor(App):
    """QuantForge CLI monitoring application"""
    ...
    def select_changed(self, event: Select.Changed) -> None:
        if event.value != Select.BLANK:
            ...
            self.title = f"QuantForge Monitor - {self.current_strategy}"

    def on_mount(self):
        self.title = "QuantForge Monitor"
