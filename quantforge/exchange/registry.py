...
from quantforge.exchange.base_factory import ExchangeFactory
...
class ExchangeRegistry:
    ...
    def discover_factories(self) -> None:
        ...
        This method scans the quantforge.exchange package for factory modules
        ...
        try:
            import quantforge.exchange as exchange_package
            ...
            for importer, modname, ispkg in pkgutil.iter_modules(package_path):
                ...
                try:
                    ...
                    factory_module_name = f"quantforge.exchange.{modname}.factory"
