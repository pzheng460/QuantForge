...
def _serialize_result(
    ...
    if len(equity) == 0:
        return BacktestResultOut(
            ...
            max_drawdown_pct=0, max_dd_duration_days=0, sharpe_ratio=0,
            sharpe_ci_lo=None, sharpe_ci_hi=None,
            sortino_ratio=0, calmar_ratio=0, annualized_volatility_pct=0,
            recovery_factor=0, total_trades=0, win_rate_pct=0,
            profit_factor=0, payoff_ratio=0, avg_win=0, avg_loss=0, expectancy=0,
            largest_win=0, largest_loss=0, max_consecutive_wins=0,
            max_consecutive_losses=0, avg_trade_duration_hours=0,
    ...
    return BacktestResultOut(
        ...
        max_dd_duration_days=_safe(metrics_full.get("max_dd_duration_days", 0)),
        ...
        annualized_volatility_pct=_safe(metrics_full.get("annualized_volatility_pct", 0)),
        recovery_factor=_safe(metrics_full.get("recovery_factor", 0)),
        ...
        payoff_ratio=_safe(metrics_full.get("payoff_ratio", 0)),
        ...
        max_consecutive_wins=int(metrics_full.get("max_consecutive_wins", 0)),
        max_consecutive_losses=int(metrics_full.get("max_consecutive_losses", 0)),
        avg_trade_duration_hours=_safe(metrics_full.get("avg_trade_duration_hours", 0)),
