"""Backtest run, status, and WebSocket streaming endpoints."""
...
async def backtest_websocket(websocket: WebSocket, job_id: str):
    ...
    Sends a JSON message every second until the job completes or fails.
    Final message includes the full result payload.
    """
