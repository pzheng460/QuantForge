...
The core of the quantforge user experience lies in creating and managing trading strategies. A trading strategy is defined by subclassing the ``Strategy`` class and implementing the methods necessary for the user's trading logic.
...
.. code-block:: python
    ...
    from quantforge.schema import BookL1, Trade, Kline  
...
.. code-block:: python
    ...
    from quantforge.schema import Order
...
quantforge supports multiple modes of operation to cater to different trading strategies and requirements. Each mode allows for flexibility in how trading logic is executed based on market conditions or specific triggers.
